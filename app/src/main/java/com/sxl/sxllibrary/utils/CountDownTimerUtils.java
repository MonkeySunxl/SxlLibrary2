...
//        mTextView.setBackgroundResource(R.drawable.btn_gray); //设置按钮为灰色，这时是不能点击的
...
//        mTextView.setBackgroundResource(R.drawable.btn_common);  //还原背景色
        mTextView.setTextColor(Color.parseColor("#999999"));
    }
}
